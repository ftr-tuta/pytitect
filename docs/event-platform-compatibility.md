...
| --- | --- | --- |
| Messaging, async runtimes, sagas, jobs, projections, event sourcing | Preview | `titect-message/1` |
...
NATS and AWS have semantic parity for the envelope, inbox/outbox, retries, terminal quarantine, and
